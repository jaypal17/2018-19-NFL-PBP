...
df = pd.read_csv('reg_pbp_2018_CarMel_RmvCol_for_firstdown_success.csv')
...
for index, row in df.iterrows():
    ...
    if row['first_down_rush'] == 1 or row['first_down_pass'] == 1 or row['first_down_penalty'] == 1\
        ...
        if row['fourth_down_failed'] == 1 or row['interception'] == 1 or row['safety'] == 1 or row['fumble_lost'] == 1:
